...
PATCHES=(
	...
	"${FILESDIR}"/${PN}-1.34.1-mtp-fix-volume-removal-with-current-udev-behavior.patch
	"${FILESDIR}"/${PN}-1.34.1-gphoto2-fix-volume-removal-with-current-udev-behavior.patch
	"${FILESDIR}"/${PN}-1.34.1-monitor-remove-device-file-checks.patch
)
