...
PATCHES=(
	...
	"${FILESDIR}/gobject-introspection-1.70.0-build.patch"
	"${FILESDIR}/gobject-introspection-1.70.0-doctool.patch"
	"${FILESDIR}/gobject-introspection-1.70.0-meson-0.61.patch"
)
